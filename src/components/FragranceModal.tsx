            ...
            {post && (
                ...
                >
                    ...
                    <motion.div
                        ...
                        className="relative z-10 w-full sm:max-w-2xl md:max-w-4xl max-h-[90vh] sm:max-h-[88vh] overflow-y-auto modal-scroll bg-surface-container-lowest flex flex-col sm:flex-row rounded-t-2xl sm:rounded-2xl overflow-hidden ghost-border"
                    ...
                    >
                        ...
                        <button
                            onClick={onClose}
                            className="absolute top-3 right-3 sm:top-4 sm:right-4 z-20 w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-[#692484]/10 hover:bg-[#692484]/30 ghost-border flex items-center justify-center text-[#692484] transition-colors duration-200 cursor-pointer"
                            aria-label="Close"
                        >
                        ...
                        <div className="relative w-full sm:w-[42%] flex-shrink-0 bg-[#692484]/10 dark:bg-[#692484]/20 flex items-center justify-center overflow-hidden min-h-[200px] sm:min-h-[280px] md:min-h-0">
                            ...
                            {/* Topic badge */}
                            {post.topic && (
                                <div className="absolute bottom-3 left-3 sm:bottom-5 sm:left-5 z-20 px-2.5 py-0.5 sm:px-3 sm:py-1 primary-gradient-cta text-white rounded-sm viscous-transition shadow-lg shadow-[#692484]/20 text-[9px] sm:text-[10px] uppercase tracking-[0.15em] sm:tracking-[0.2em] font-bold rounded-full">
                                    {post.topic}
                                </div>
                            )}
                        </div>
                        ...
                        <div className="flex-1 p-4 sm:p-6 md:p-10 flex flex-col justify-between overflow-y-auto">
                            ...
                            <div>
                                ...
                                <motion.h2
                                    ...
                                    className="font-['Space_Grotesk'] text-xl sm:text-2xl md:text-3xl font-black uppercase leading-[1.15] tracking-tight text-[#2C143B] dark:text-[#F1E3FC] mb-4 sm:mb-6"
                                >
                                    {post.title}
                                </motion.h2>
                                ...
                                {aromaticSection && (
                                    <motion.div
                                        ...
                                        className="rounded-xl p-3 sm:p-5 mb-5 sm:mb-7 bg-surface-container"
                                    >
                            ...
                            >
                                <a
                                    ...
                                    className="group relative w-full text-center py-3 sm:py-3.5 primary-gradient-cta text-white rounded-sm viscous-transition shadow-lg shadow-[#692484]/20 text-[10px] sm:text-xs uppercase tracking-[0.15em] sm:tracking-[0.2em] font-bold overflow-hidden hover:shadow-lg hover:shadow-[#692484]/30 transition-shadow cursor-pointer rounded-sm"
                                >
                                ...
                                <button
                                    onClick={onClose}
                                    className="w-full px-6 py-2.5 sm:py-3.5 ghost-border text-[#692484] text-[10px] sm:text-xs uppercase tracking-[0.15em] sm:tracking-[0.2em] font-bold hover:bg-[#692484]/10 transition-colors cursor-pointer rounded-sm"
                                >
                                    Close
                                </button>
                            </motion.div>
